...
[Serializable]
[PostProcess(typeof(GegeEdgeDetectionRenderer), PostProcessEvent.AfterStack, "Gege/EdgeDetection")]
public sealed class GegeEdgeDetection : PostProcessEffectSettings
{
...
public sealed class GegeEdgeDetectionRenderer : PostProcessEffectRenderer<GegeEdgeDetection>
{
    ...
    public override void Render(PostProcessRenderContext context)
    {
        ...
        // Set properties
        var sheet = context.propertySheets.Get(Shader.Find("Hidden/Gege/EdgeDetection"));
