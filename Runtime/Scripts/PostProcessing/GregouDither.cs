...
{
    [Serializable]
    [PostProcess(typeof(GregouDitherRenderer), PostProcessEvent.AfterStack, "Gregou/Dither")]
    public sealed class GregouDither : PostProcessEffectSettings
    {
    ...
    public sealed class GregouDitherRenderer : PostProcessEffectRenderer<GregouDither>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            // Set properties
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/Gregou/Dither"));
